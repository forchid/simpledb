...
public class CreateIndexedStudentDB {
   public static void main(String[] args) {
      ...
      try (Connection conn = d.connect("studentdb", null);
         ...
         s = "create index SID_IDX on STUDENT(SId)";
         stmt.executeUpdate(s);
         s = "create index MAJOR_IDX on STUDENT(MajorId)";
         stmt.executeUpdate(s);
         System.out.println("Indexes on STUDENT created.");
         ...
         s = "create index STUDENT_IDX on ENROLL(StudentId)";
         stmt.executeUpdate(s);
         System.out.println("Index on ENROLL created.");
